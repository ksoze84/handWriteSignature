...
function handDrawnSign(canvas, signString, options) {
    if (canvas) {
        const ctx = canvas.getContext("2d");
        if (ctx) {
            const points = [];
            const usable = (options === null || options === void 0 ? void 0 : options.usableProportionArea) || 0.5;
            const controlPointProportion = (options === null || options === void 0 ? void 0 : options.controlPointProportion) || 1.3;
            let i = 0;
            let minC = 1000000;
            let maxC = -1000000;
            ...
            if (options === null || options === void 0 ? void 0 : options.strokeStyle)
                ctx.strokeStyle = options === null || options === void 0 ? void 0 : options.strokeStyle;
            if (options === null || options === void 0 ? void 0 : options.lineWidth)
                ctx.lineWidth = options === null || options === void 0 ? void 0 : options.lineWidth;
            ctx.stroke();
        }
    }
}

exports.handDrawnSign = handDrawnSign;
